...
sudo dpkg --force-all -i libfreetype6_2.8-0.2ubuntu2.1_amd64.deb

echo "Stopping the packages from being updated using apt (holding)"
sudo apt-mark hold libfreetype6:i386
sudo apt-mark hold libfreetype6:amd64
...
echo " "
echo "Reboot, and hopefully this fixed your font problem!"
